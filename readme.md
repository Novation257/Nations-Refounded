...
# Installing/running
Nations Refound can be downloaded [here](https://github.com/cs340-25/Nations-Refounded/blob/main/ClientApp/builds/Nations-Refounded_0.1.1.exe), and *should* be compatible with modern Windows and Mac machines.
